...
//#define SDA_IN()        {GPIOC->MODER&=0X0FFFFFFF;GPIOC->MODER &=~((uint32_t)1<<18);} //MODER:00
...
#define SCL_SetHigh()               HAL_GPIO_WritePin(I2C_SCL_GPIO_Port , I2C_SCL_Pin, GPIO_PIN_SET)
#define SCL_SetLow()                HAL_GPIO_WritePin(I2C_SCL_GPIO_Port , I2C_SCL_Pin, GPIO_PIN_RESET)

#define SDA_SetHigh()               HAL_GPIO_WritePin(I2C_SDA_GPIO_Port , I2C_SDA_Pin, GPIO_PIN_SET)
#define SDA_SetLow()                HAL_GPIO_WritePin(I2C_SDA_GPIO_Port , I2C_SDA_Pin, GPIO_PIN_RESET)
